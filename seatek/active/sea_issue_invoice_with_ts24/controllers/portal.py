...
class PortalAccount(portal.PortalAccount):
    ...
    def portal_my_invoice_detail(self, invoice_id, access_token=None, report_type=None, download=False, **kw):
        ...
        """
        try:
            invoice_sudo = self._document_check_access('invoice.consolidation', invoice_id, access_token)
        ...
        if report_type == 'xml':
            ...
            return super(PortalAccount, self).portal_my_invoice_detail(invoice_id, access_token, report_type, download,
                                                                       **kw)
    ...
    def _show_report(self, model, report_type, report_ref, download=False):
        ...
        Override to add support for downloading S-Invoice in zipped XML
        """
        if model._name == 'invoice.consolidation' and model.sinvoice_state != 'not_issued' and report_type == 'xml':
            try:
