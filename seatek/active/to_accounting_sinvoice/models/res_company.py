...
class ResCompany(models.Model):
    ...
    # account_sinvoice_serial_id = fields.Many2one('account.sinvoice.serial', string='Invoice Serial',
    #                                              ondelete='restrict',
    ...
    # account_sinvoice_template_id = fields.Many2one('account.sinvoice.template', string='S-Invoice Template',
    #                                                ondelete='restrict',
