odoo.define('seatek_hr_appraisal.surveyjs', function (require) {
'use strict';
...
//        $('.js_surveyform :input').prop('disabled', false);
//        print_mode = true;
//    }
            ...
            var prefill_def = $.ajax(prefill_controller, {dataType: "json"})
                .done(function(json_data){
                    _.each(json_data, function(value, key){
                        ...
                        the_form.find("input[name=" + key + "][type='number']").each(function(){
                            $(this).val(value);
                        });
