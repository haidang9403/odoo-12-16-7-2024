odoo.define('seatek_hr_appraisal.appraisal_form', function (require) {
"use strict";
...
var AppraisalFormRenderer = FormRenderer.extend({
    ...
    init: function () {
        ...
        console.log('Appraisal Form Renderer')
    },
...
var AppraisalFormModel = BasicModel.extend({
    /**
     * @override
     */
    save: function (recordID) {
        var self = this;
        console.log('Appraisal Form Model');
...
var AppraisalFormView= FormView.extend({
    jsLibs: [],

    config: _.extend({}, FormView.prototype.config, {
        Model: AppraisalFormModel,
        Renderer: AppraisalFormRenderer,
        Controller: AppraisalFormController,
    }),
    ...
    */
    init: function () {
        console.log('Appraisal Form View');
        this._super.apply(this, arguments);

    },
});

view_registry.add('appraisal_form', AppraisalFormView);
