odoo.define('seatek_employees_optional.employees_optional', function (require) {
"use strict";
...
var Employees_Optional = AbstractField.extend({
...
field_registry.add('employees_optional', Employees_Optional);
return Employees_Optional;
});
