odoo.define('sea_sale_order_extend.SaleOrder', function (require) {
    "use strict";
...
var Many2OneSearchMorePartner = AbstractField.extend({
...
//        console.log("this: ", self);
        ...
        self.attrs.domain = [['id','in', Array.from(context.domain)]];
        ...
        this._rpc({
            ...
            .then(function (result) {
                ...
                // search more... always
                self.attrs.domain = eval(context.domain_search_more);
...
fieldRegistry.add('many2one_search_more_partner', Many2OneSearchMorePartner);
});
