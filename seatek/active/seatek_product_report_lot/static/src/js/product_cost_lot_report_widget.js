odoo.define('seatek_product_report_lot.product_cost_lot_report_widget', function
(require) {
    'use strict';
    ...
    var ProductCostLotReportWidget = Widget.extend({
        events: {
        ...
        console.log("click e",e);
            ...
            console.log("click res_model",res_model);
    ...
    return ProductCostLotReportWidget;
