"use strict";
odoo.define('sea_pos_order_customer_invoice.popup_select_invoice_address', function (require) {
    ...
    var popup_select_invoice_address = PopupWidget.extend({
        template: 'popup_select_invoice_address',
    ...
    gui.define_popup({
        name: 'popup_select_invoice_address',
        widget: popup_select_invoice_address
    });
});